...
elif jeu == "Fortnite": st.subheader("Stats Fortnite") victoires = st.number_input("Victoires", 0) parties_jouees = st.number_input("Parties jouées", 1) tirs_touches = st.number_input("Tirs touchés", 0) tirs_rates = st.number_input("Tirs ratés", 0) eliminations = st.number_input("Éliminations", 0)
